    ...
    <div className="absolute z-10 flex items-center w-full top-2/4">
      <button
        ...
        className={`${buttonClassName} ${buttonSize === 'default'
          ...
          } text-black flex items-center justify-center rounded-full text-gray-0 bg-white absolute transition duration-250 hover:bg-gray-900 hover:text-white focus:outline-none ${buttonPosition === 'inside'
      ...
      <button
        ...
        className={`${buttonClassName} ${buttonSize === 'default'
          ...
          } text-black flex items-center justify-center rounded-full bg-white absolute transition duration-250 hover:bg-gray-900 hover:text-white focus:outline-none ${buttonPosition === 'inside'
